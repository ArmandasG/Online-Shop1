    ...
    <div className="lg:min-h-[71rem] container items-center gap-40 flex flex-col lg:flex-row lg:items-start">
      ...
      <div className="flex flex-col items-center w-full text-3xl lg:text-5xl lg:pt-[30rem] lg:mb-[10rem]">
        <div className="border border-black rounded-lg p-10 space-y-8">
          ...
          <Link
            className="border w-full block text-center border-black rounded-md py-4 px-30 hover:bg-black hover:text-white ease-in-out duration-300"
            to={"/register"}
          >
          ...
          <button
            ...
            className="border w-full flex justify-center border-black rounded-md py-4 px-30 hover:text-white hover:bg-black ease-in-out duration-300"
          >
            <img
              className="w-8 mr-2 lg:w-12"
              src="/google.png"
              alt="googleIcon"
            />
