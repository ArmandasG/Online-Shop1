...
function Cart({ myCartNav, onClose }) {
  ...
  return (<div>
    {cartIsOpen && windowWidth >=1024 ? <div onClick={onClose} className={`absolute h-16 w-16 ${cartIsOpen && windowWidth < 1280 ? 'right-[30%]' : 'right-[20%]' }  top-[0%] border border-black bg-black text-white close-icon flex justify-center items-center appear-from-right cursor-pointer`}><span className="text-4xl">x</span></div> : ''}
