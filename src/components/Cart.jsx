  ...
  return (
    <div className="cartOverlay pt-4" id={myCartNav}>
      <div className="ml-8 mt-4 mr-8">
        ...
        <div className="flex">
        <button onClick={() => {setCartArr([]), setTempCart([]), ui.showSuccess('All Items Removed From Cart')}} className="py-4 px-5 mt-4 border border-black mr-4"><i className="fa fa-refresh" aria-hidden="true"></i></button>
