  ...
  return (
    <footer className="mt-4 text-xl">
      <div className="flex justify-around lg:justify-center lg:gap-40 lg:text-xl">
        ...
        {windowWidth >= 1024 ? <Link className="hover:text-gray-400" to={"/what-to-know"}>Press</Link> : ""}
        {windowWidth >= 1024 ? <Link className="hover:text-gray-400" to={"/find-us"}>Find Us</Link> : ""}
